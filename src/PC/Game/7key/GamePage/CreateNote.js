...
export const checkPos = (index) => {
  if (index === 0) {
    ...
    return 60 + 60 + 60 + 70 + 60;
  } else if (index === 6) {
    return 60 + 60 + 60 + 70 + 60 + 60;
  }
};
//현재 노트의 가로폭 찾기

export const checkWidth = (index) => {
  if (index === 3) {
    return 70;
  } else {
    return 60;
...
export const checkColor = (index) => {
  if (index === 0) {
    ...
    return "linear-gradient(to right,rgb(45, 57, 90),rgb(51, 158, 247),rgb(51, 158, 247),rgb(45, 57, 90))";
  } else if (index === 2) {
    return "linear-gradient(to right, gray, white, white, gray)";
  } else if (index === 3) {
